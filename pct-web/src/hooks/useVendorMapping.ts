...
import { loadVendorMapping } from '../data-clients/vendorMappingClient';
...
// loading, or if the mapping source is briefly unavailable — this must never block/crash the dashboard.
