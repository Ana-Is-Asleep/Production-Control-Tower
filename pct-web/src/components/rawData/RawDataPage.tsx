      ...
      <div className="flex-1 min-w-0 flex flex-col overflow-hidden">
        <div className="bg-white border-b border-[#e9e3df] px-5 py-2.5 shrink-0 flex items-center justify-between gap-4 flex-wrap">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link to="/data-dictionary" className="flex items-center gap-1.5 text-xs font-semibold text-[#403833] border border-[#e9e3df] rounded-lg px-3 py-1.5 hover:border-[#403833] transition-colors">
