          ...
          <div className="bg-white rounded-lg p-6" style={{ boxShadow: 'var(--shadow-card)' }}>
            ...
            <ResponsiveContainer width="100%" height={300}>
              <BarChart data={chartWeeklyLT} margin={{ top: 4, right: 24, left: -10, bottom: 0 }} barCategoryGap="25%">
                ...
                {selectedCat === 'All' ? (
                  <>
                    <Bar dataKey="Mattresses"  fill="#FF8900" fillOpacity={0.82} radius={[3,3,0,0]} maxBarSize={22} name="Mattresses" />
                    <Bar dataKey="Beds"        fill="#6469aa" fillOpacity={0.82} radius={[3,3,0,0]} maxBarSize={22} name="Beds" />
                    <Bar dataKey="Accessories" fill="#34A853" fillOpacity={0.82} radius={[3,3,0,0]} maxBarSize={22} name="Accessories" />
                  </>
                ) : (
                  <Bar dataKey={selectedCat} fill={CATEGORY_COLORS[selectedCat]} fillOpacity={0.82} radius={[3,3,0,0]} maxBarSize={30} name={selectedCat} />
                )}
              </BarChart>
            </ResponsiveContainer>
          </div>
