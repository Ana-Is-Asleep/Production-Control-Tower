...
import { BarChart, Bar, ComposedChart, Line, XAxis, YAxis, Tooltip, ResponsiveContainer, ReferenceLine, Legend, CartesianGrid } from 'recharts';
import { SlideOver } from '../shared/SlideOver';
import { Seg } from '../shared/Seg';
import { MiniLegend } from '../shared/MiniLegend';
import { computeLeadTime, summariseLeadTimes, computeWeeklyLT, computeWeeklyLTTargetSplit } from '../../lib/leadTimeUtils';
...
export function LeadTimeSection({ lines }: LeadTimeSectionProps) {
  ...
  return (
    <>
      <div onClick={() => setOpen(true)} className="kpi-card bg-white rounded-lg border border-[#e9e3df] px-5 py-4 cursor-pointer flex flex-col h-full overflow-hidden" style={{ boxShadow: 'var(--shadow-card)' }}>
