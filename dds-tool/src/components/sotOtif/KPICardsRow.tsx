...
import { CalendarCheck2, Clock, Timer } from 'lucide-react';
...
export function KPICardsRow({ totalPOs, onTimeCount, lateCount, avgDelayDays, weekLabel, sotTarget }: KPICardsRowProps) {
  return (
